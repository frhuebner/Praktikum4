...
fit l(x,a1,b1) "zeeman_neu_neu.txt" using "B":(column("order") == -2 ? abs(column("deltaE-")*1e24): 1/0):"dB":(column("ddeltaE-")*1e24) xyerrors via a1,b1
fit l(x,a2,b2) "zeeman_neu_neu.txt" using "B":(column("order") == -2 ? abs(column("deltaE+")*1e24): 1/0):"dB":(column("ddeltaE+")*1e24) xyerrors via a2,b2
fit l(x,a3,b3) "zeeman_neu_neu.txt" using "B":(column("order") == -1 ? abs(column("deltaE-")*1e24): 1/0):"dB":(column("ddeltaE-")*1e24) xyerrors via a3,b3
fit l(x,a4,b4) "zeeman_neu_neu.txt" using "B":(column("order") == 1 ? abs(column("deltaE+")*1e24): 1/0):"dB":(column("ddeltaE+")*1e24) xyerrors via a4,b4
fit l(x,a5,b5) "zeeman_neu_neu.txt" using "B":(column("order") == 2 ? abs(column("deltaE-")*1e24): 1/0):"dB":(column("ddeltaE-")*1e24) xyerrors via a5,b5
fit l(x,a6,b6) "zeeman_neu_neu.txt" using "B":(column("order") == 2 ? abs(column("deltaE+")*1e24): 1/0):"dB":(column("ddeltaE+")*1e24) xyerrors via a6,b6
set output "out_zeeman_neu_neu.png"

plot \
 "zeeman_neu_neu.txt" using "B":(column("order") == -2 ? abs(column("deltaE-")): 1/0):"dB":"ddeltaE-" with xyerrorbars title "linkslambda-" lt rgb "red",\
 l(x,a1/1e24,b1/1e24) notitle lt rgb "red",\
 "zeeman_neu_neu.txt" using "B":(column("order") == -2 ? abs(column("deltaE+")): 1/0):"dB":"ddeltaE+" with xyerrorbars title "linkslambda+" lt rgb "blue",\
 l(x,a2/1e24,b2/1e24) notitle lt rgb "blue",\
 "zeeman_neu_neu.txt" using "B":(column("order") == -1 ? abs(column("deltaE-")): 1/0):"dB":"ddeltaE-" with xyerrorbars title "mittelambda-" lt rgb "red",\
 l(x,a3/1e24,b3/1e24) notitle lt rgb "red",\
 "zeeman_neu_neu.txt" using "B":(column("order") == 1 ? abs(column("deltaE+")): 1/0):"dB":"ddeltaE+" with xyerrorbars title "mittelambda+" lt rgb "blue",\
 l(x,a4/1e24,b4/1e24) notitle lt rgb "blue",\
 "zeeman_neu_neu.txt" using "B":(column("order") == 2 ? abs(column("deltaE-")): 1/0):"dB":"ddeltaE-" with xyerrorbars title "rechtslambda-" lt rgb "red",\
 l(x,a5/1e24,b5/1e24) notitle lt rgb "red",\
 "zeeman_neu_neu.txt" using "B":(column("order") == 2 ? abs(column("deltaE+")): 1/0):"dB":"ddeltaE+" with xyerrorbars title "mittelambda+" lt rgb "blue",\
