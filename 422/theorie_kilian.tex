...
Der grobe Aufbau eines RTM ist in Abbildung \ref{fig:RTM} zu sehen und wird in \cite{RWTH} detailliert erklärt. Durch das Anlegen einer Spannung $U$ zwischen Spitze und Probe können die Fermi-Niveaus beider Materialien so gegeneinander verschoben werden, dass ein Netto-Elektronenfluss von Spitze zu Probe (oder andersherum) entstehen kann. 
