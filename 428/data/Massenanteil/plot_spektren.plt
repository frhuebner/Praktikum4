...
fit f(x) 'ag.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,a3,a4,a5,m1,m2,m3,m4,m5,s1,s2,s3,s4,s5
...
set output 'ag.eps'
p f(x) title 'Regr.', 'ag.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'au.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,a3,a4,m1,m2,m3,m4,s1,s2,s3,s4
...
set output 'au.eps'
p f(x) title 'Regr.', 'au.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'cu.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,m1,m2,s1,s2
...
set output 'cu.eps'
p f(x) title 'Regr.', 'cu.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'fe.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,m1,m2,s1,s2
...
set output 'fe.eps'
p f(x) title 'Regr.', 'fe.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'in.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,a3,a4,m1,m2,m3,m4,s1,s2,s3,s4
...
set output 'in.eps'
p f(x) title 'Regr.', 'in.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'ni.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,m1,m2,s1,s2
...
set output 'ni.eps'
p f(x) title 'Regr.', 'ni.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'pb.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,a3,a4,a5,m1,m2,m3,m4,m5,s1,s2,s3,s4,s5
...
set output 'pb.eps'
p f(x) title 'Regr.', 'pb.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'sn.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,a3,a4,m1,m2,m3,m4,s1,s2,s3,s4
...
set output 'sn.eps'
p f(x) title 'Regr.', 'sn.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'ti.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,m1,s1
...
set output 'ti.eps'
p f(x) title 'Regr.', 'ti.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'w.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,a3,a4,m1,m2,m3,m4,s1,s2,s3,s4
...
set output 'w.eps'
p f(x) title 'Regr.', 'w.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'zn.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,m1,s1
...
set output 'zn.eps'
p f(x) title 'Regr.', 'zn.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'zr.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,m1,m2,s1,s2
...
set output 'zr.eps'
p f(x) title 'Regr.', 'zr.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'probe_1.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,m1,m2,s1,s2
...
p f(x) title 'Regr.', 'probe_1.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'probe_2.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,m1,m2,s1,s2
...
p f(x) title 'Regr.', 'probe_2.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'probe_3.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,m1,m2,s1,s2
...
p f(x) title 'Regr.', 'probe_3.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
...
fit f(x) 'probe_4.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) xerr via a,b,a1,a2,m1,m2,s1,s2
...
p f(x) title 'Regr.', 'probe_4.txt' u (0.0684*($1)-0.655):2:(sqrt(0.3**2+(0.003*($1))**2)) w xerrorbars title 'Messwerte'
