...
plot "edit_160.dat" using 1:2 title "U" with lines  lt rgb "black",\
	"edit_160.dat" using 1:($4+10) title "I+10V" with lines  lt rgb "red",\
	"edit_160.dat" using 1:($3+12) title "Q+12V" with lines  lt rgb "blue" 
	
set output "plot_ig.png"
plot "edit_159.dat" using 1:2 title "U" with lines  lt rgb "black",\
	"edit_159.dat" using 1:($4+10) title "I+10V" with lines  lt rgb "red",\
	"edit_159.dat" using 1:($3+12) title "Q+12V" with lines  lt rgb "blue" 

set yrange [-2:12]
	
set output "plot_icg.png"
plot "edit_160.dat" using 1:($4) title "Carr-Purcell I" with lines  lt rgb "black",\
	"edit_160.dat" using 1:($3+3) title "Carr-Purcell Q+3V" with lines  lt 2 lc rgb "gray",\
	"edit_159.dat" using 1:($4+5) title "Meiboom-Gill I+5V" with lines  lt rgb "red",\
	"edit_159.dat" using 1:($3+8) title "Meiboom-Gill Q+8V" with lines  lt 2 lc rgb "blue" 
