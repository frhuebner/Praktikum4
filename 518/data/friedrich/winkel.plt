...
set output "winkel.png"
plot "winkel.txt" using 3:5:4:6 with xyerrorbars notitle lt rgb "black"
...
set output "winkel_cos.png"
plot "winkel2.txt" using 7:5:8:6 with xyerrorbars notitle lt rgb "black",\
...
b=-150
n=1
fit f(x) "winkel2.txt" using 7:5:8:6 xyerrors via a,b,n

set output "winkel_cos_n.png"
plot "winkel2.txt" using 7:5:8:6 with xyerrorbars notitle lt rgb "black",\
	f(x) title "Regr." lt rgb "black"