...
fit N(x) '2.txt' u 1:($2 == 0 ? NaN : $2) via A1,A2,t1,t2,t0,s,BG  
set output '2.eps' 
p '2.txt' notitle, N(x) notitle

fit N(x) '3.txt' u 1:($2 == 0 ? NaN : $2) via A1,A2,t1,t2,t0,s,BG  
set output '3.eps' 
p '3.txt' notitle, N(x) notitle

fit N(x) '4.txt' u 1:($2 == 0 ? NaN : $2) via A1,A2,t1,t2,t0,s,BG  
set output '4.eps' 
p '4.txt' notitle, N(x) notitle

fit N(x) '5.txt' u 1:($2 == 0 ? NaN : $2) via A1,A2,t1,t2,t0,s,BG  
set output '5.eps' 
